...
modeltype2path = {
    ...
    "llama2-7b-hf": "meta-llama/Llama-2-7b",
    "llama2-13b-hf": "meta-llama/Llama-2-13b",
    "llama2-7b-chat-fp16": "TheBloke/Llama-2-7B-Chat-fp16",
}
...
def main():
    ...
    parser.add_argument("--model", type=str, default="llama2-7b-chat-fp16")
